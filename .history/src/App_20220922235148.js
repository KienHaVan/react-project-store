  ...
  return (
    <div className="app page-container">
      ...
      <div className="banner flex items-stretch justify-between gap-5 mb-5">
        <div className="banner-left relative w-full rounded-lg">
          <img
        ...
        <div className="banner-right flex flex-col gap-5">
          <div className="p-5 bg-gray-200 rounded-lg flex flex-col gap-3">
            <h2 className="font-bold text-xl">Miễn phí vận chuyển</h2>
            <p>
          ...
          <div className="p-5 bg-gray-200 rounded-lg">
            <h2>Đổi trả 1-1 hoặc hoàn tiền</h2>
            <p>
