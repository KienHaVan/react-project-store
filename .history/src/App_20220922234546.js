function App() {
  return (
    <div className="app page-container">
      ...
      <div className="banner flex items-center justify-between gap-3 mb-5">
        <div className="banner-left order-3 relative"></div>
        <div className="banner-right order-1 flex flex-col gap-3">
          <div>
