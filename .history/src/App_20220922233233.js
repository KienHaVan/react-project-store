function App() {
  return (
    <div className="app">
      <div className="header page-container flex items-center justify-start gap-5 pt-3 pb-3 border-b border-b-gray-400">
      ...
      <div className="banner flex items-center justify-center gap-x-5">
