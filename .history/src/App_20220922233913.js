function App() {
  return (
    <div className="app">
      <div className="header page-container flex items-center justify-start gap-x-5">
      ...
      <div className="banner flex items-center justify-center gap-x-5 mt-5">
      ...
      <div className="banner flex items-center justify-between"></div>
    </div>
  );
}
