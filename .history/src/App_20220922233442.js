function App() {
  return (
    <div className="app">
      <div className="header page-container flex items-center justify-start gap-x-5 py-1 pb-1 border-b border-b-gray-400">
      ...
      <div className="banner flex items-center justify-center gap-x-5 mt-1">
