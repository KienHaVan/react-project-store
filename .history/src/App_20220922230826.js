  ...
  return (
    <>
      <div className="header page-container flex items-center justify-start gap-5">
        ...
        <label
          htmlFor="search"
          className="flex-1 py-2 px-4 bg-gray-200 flex items-center gap-4 rounded-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
          ...
          />
          <button className="flex-shrink-0 px-4 py-2 bg-primary text-white font-semibold rounded-2xl">
            Tìm Kiếm
          </button>
        </label>
      </div>
