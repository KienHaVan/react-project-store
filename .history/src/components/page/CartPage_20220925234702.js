  ...
  return (
    <div className="flex items-start gap-10">
      ...
      <div className="cartList-right basis-1/3 flex-shrink-0">
        ...
        <div className="flex items-start p-3 rounded-xl border border-green-500 bg-green-200 gap-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <span className="text-green-800">
            Đơn hàng đã đủ điều kiện miễn phí vận chuyển khi thanh toán trước.
          </span>
        </div>
      </div>
    </div>
