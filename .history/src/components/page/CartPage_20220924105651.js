...
const CartPage = () => {
  ...
  return (
    <div className="pt-[110px]">
      ...
      <div className="cart-container w-full rounded-xl flex items-center justify-center">
...
function CartEmpty() {
  return (
    <div className="relative w-full bg-blue-100  min-h-[300px] flex flex-col items-center justify-center">
