...
function CartList({ data }) {
  return (
    <div className="flex items-start gap-10">
      ...
      <div className="cartList-right basis-1/3 flex-shrink-0 rounded-xl">
        <div className="flex flex-col gap-5">
          <div className="header flex items-center gap-3 bg-blue-100 p-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <span className="font-semibold text-lg">Mã khuyến mại</span>
          </div>
        </div>
      </div>
    </div>
