...
const CartPage = () => {
  ...
  return (
    <div className="pt-[110px]">
      ...
      <div className="cart-container w-full  min-h-[300px] rounded-xl flex items-center justify-center">
...
function CartEmpty() {
  return (
    <div className="relative w-full bg-blue-100 h-full flex flex-col items-center justify-center">
...
function CartList() {
  return (
    <div className="flex items-start">
      <div className="cartList-left"></div>
    </div>
  );
}
