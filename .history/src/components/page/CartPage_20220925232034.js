    ...
    <div className="flex items-start gap-10">
      ...
      <div className="cartList-right basis-1/3 flex-shrink-0">
        <div className="flex flex-col gap-5">
          <div className="header flex items-center gap-3 bg-blue-100 p-3 rounded-xl">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div className="content flex gap-3 bg-blue-100 rounded-xl p-3 relative">
            ...
            <div className="w-full p-3 rounded-xl pl-[80px]">
              <input
                type="text"
