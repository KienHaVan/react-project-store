...
const CartPage = () => {
  ...
  console.log("file: CartPage.js ~ line 7 ~ cartItemHandled", cartItemHandled);
  useEffect(() => {
...
function CartList({ data }) {
  ...
  console.log("file: CartPage.js ~ line 71 ~ isValid", isValid);
  return (
...
function CartItem({ item, setIsValid }) {
