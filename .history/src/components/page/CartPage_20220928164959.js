    ...
    isValid && (
      <div className=" basis-2/3 flex w-full items-start gap-5 bg-blue-100 rounded-xl p-4">
        ...
        <div className="flex items-center gap-5">
          ...
          <span className="font-semibold text-lg w-2">{quantity}</span>
          <button
            className="font-semibold text-lg"
        ...
        <div className="w-[100px] flex flex-col items-end justify-start gap-5">
          <span className="text-primary text-xl font-semibold ml-auto">
