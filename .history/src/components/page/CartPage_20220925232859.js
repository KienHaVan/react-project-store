      ...
      <div className="cartList-right basis-1/3 flex-shrink-0">
        <div className="flex flex-col gap-5 bg-blue-100 rounded-xl p-3">
          ...
          <div className="content flex gap-3 rounded-xl p-3 relative bg-blue-700">
            ...
            <div className="w-full rounded-xl pl-[80px] flex items-center">
              <input
                type="text"
              ...
              />
              {voucherData && (
                <span className="text-secondary uppercase font-medium text-xl flex-shrink-0 bg-white h-[48px] rounded-xl">
                  ÁP DỤNG
                </span>
              )}
            </div>
