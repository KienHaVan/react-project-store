...
const Footer = () => {
  return (
    <>
      <div className="mt-10">
        ...
        phẩm, ThinkPro xin cam kết sẽ hỗ trợ Quý khách tới cùng."
            ...
            <div className="flex flex-col gap-3 ">
              ...
              <span className="font-bold text-xl">Thông tin hữu ích</span>
              <div className="grid grid-cols-2 gap-y-3 gap-x-8 pb-5 mb-5 border-b border-b-gray-200">
                <FooterMiniItem
                  icon={
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="mt-10 bg-white rounded-xl flex items-start justify-between box-shadow">
        <div className="left w-1/2 px-10 py-5 flex flex-col">
          ...
          <div className="grid grid-cols-3 mt-5 gap-3">
            <span className="p-2 rounded-xl cursor-pointer text-secondary font-semibold text-lg hover:bg-blue-100">
              Về chúng tôi
            </span>
            <span className="p-2 rounded-xl cursor-pointer text-secondary font-semibold text-lg hover:bg-blue-100">
              Vì khách hàng
            ...
            <span className="p-2 rounded-xl cursor-pointer text-secondary font-semibold text-lg hover:bg-blue-100">
              <img
                src="https://thinkpro.vn/_nuxt/img/think-bocongthuong.08b4936.png"
                alt=""
              />
            </span>
          </div>
        </div>
        <div className="footer-bottom-right w-1/2 relative select-none">
          <Swiper navigation={true} modules={[Navigation]} loop={true}>
            <SwiperSlide>
              <img
                src="https://thinkpro.vn/_nuxt/img/store-1.c50f7e3.png"
                alt=""
                className="w-full h-full object-cover rounded-r-xl"
              />
            </SwiperSlide>
            <SwiperSlide>
              <img
                src="https://thinkpro.vn/_nuxt/img/store-2.aea2d40.png"
                alt=""
                className="w-full h-full object-cover rounded-r-xl"
              />
            </SwiperSlide>
            <SwiperSlide>
              <img
                src="https://thinkpro.vn/_nuxt/img/store-3.be7ac7d.png"
                alt=""
                className="w-full h-full object-cover rounded-r-xl"
              />
            </SwiperSlide>
            <SwiperSlide>
              <img
                src="https://thinkpro.vn/_nuxt/img/store-4.b9a76e0.png"
                alt=""
                className="w-full h-full object-cover rounded-r-xl"
              />
            </SwiperSlide>
...
function FooterItem({ icon, label, content }) {
  return (
    <div className="w-1/2 flex flex-col gap-3">
      ...
      <span>{content}</span>
      <button className="flex items-center justify-start gap-1 text-secondary hover:text-blue-800">
        <span className="font-medium text-lg">Chi tiết</span>
        <span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
function FooterMiniItem({ icon, text }) {
  return (
    <div className="p-3 bg-blue-50 rounded-xl flex items-center gap-3 cursor-pointer hover:bg-blue-200">
...
function FooterSocial({ logo, label }) {
  return (
    <div className="p-2 border border-gray-200 rounded-xl flex items-center justify-start gap-3 min-w-[160px] cursor-pointer cursor-pointer hover:bg-blue-50">
      <span>{logo}</span>
      <span>{label}</span>
    </div>
  );
