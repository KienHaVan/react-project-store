...
const Banner = () => {
  ...
  if (!data) return null;
  return (
    <div className="banner flex items-stretch justify-between gap-5 mb-14 max-h-[400px]">
      <div className="banner-left basis-3/4 relative w-full rounded-xl overflow-hidden h-auto">
