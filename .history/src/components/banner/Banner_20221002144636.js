  ...
  return (
    <div className="w-full h-[410px] relative">
      ...
      <div className="absolute bottom-5 left-5 flex flex-col gap-3">
        <span className="p-3 rounded-xl bg-blue-100">{item.title}</span>
        <button
          className="p-3 rounded-xl bg-primary text-white font-semibold text-lg inline-block"
          onClick={() => setCartList((prev) => [...prev, item])}
        >
          Mua Ngay
        </button>
      </div>
