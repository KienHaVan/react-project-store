...
const Header = () => {
  ...
  return (
    <div className="header page-container flex items-center justify-start gap-x-5 fixed top-0 left-0 right-0 bg-white z-10 shadow-md">
      <div className="logo -translate-y-2 cursor-pointer">
        <svg
      ...
      <div className="cart flex items-center gap-x-3 py-3 px-5 rounded-full bg-gray-200 cursor-pointer">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
      ...
      <div className="delivery p-3 rounded-full bg-gray-200 cursor-pointer">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
