  ...
  return ReactDOM.createPortal(
    <div className="User-main bg-white p-3 overflow-y-auto rounded-xl w-[425px] shadow-xl max-h-screen">
      ...
      <UserPageItem
        ...
        color="text-blue-400"
      ></UserPageItem>
      <div className="flex items-center justify-between mt-3 pb-3 border-b border-b-gray-200 mb-3">
        <MiniItem
          icon={
            <svg
              xmlns="http://www.w3.org/2000/svg"
...
function MiniItem({ icon, label, content }) {
  return (
    <div className="flex flex-col gap-[6px] items-center p-3 hover:bg-blue-100 rounded-xl cursor-pointer min-w-[100px]">
