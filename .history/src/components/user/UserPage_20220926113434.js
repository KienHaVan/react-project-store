...
const UserPage = () => {
  ...
  return ReactDOM.createPortal(
    <div className="User-main bg-white p-3 overflow-y-auto rounded-xl w-[425px] shadow-xl">
      ...
      <div className="rounded-xl p-5 border border-gray-400 relative flex items-center gap-3 mb-3">
        <img
...
function UserPageItem({ icon, label, color = "text-black", disabled = false }) {
  return (
    <div
      className={`p-3 rounded-xl flex items-center hover:bg-blue-100 ${
