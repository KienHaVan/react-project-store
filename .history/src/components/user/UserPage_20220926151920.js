...
const UserPage = () => {
  ...
  return ReactDOM.createPortal(
    <div className="User-main bg-white p-3 overflow-y-auto rounded-xl w-[425px] shadow-xl max-h-screen">
      ...
      <UserPageItem
        ...
        borderBottom
      ></UserPageItem>
      <UserPageItem icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
