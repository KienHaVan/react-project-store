  ...
  return (
    <div className="app page-container mb-20">
      <div className="header flex items-center justify-start gap-x-5 mb-5">
        ...
        <div className="menu ">
          <svg
            ...
            strokeWidth="1.5"
            stroke="currentColor"
            className="w-6 h-6 p-3 bg-gray-200 rounded-full"
          >
            <path
              strokeLinecap="round"
        ...
        <h2 className="font-semibold text-primary ">Khuyến mại</h2>
        <label
          htmlFor="search"
      ...
      <div className="product-list grid grid-cols-4 gap-5">
        <div className="product-item p-2 bg-blue-50 rounded-xl flex flex-col gap-3">
          ...
          <button className="w-full p-3 bg-secondary rounded-xl text-white font-medium">
            Mua ngay
          </button>
        </div>
      </div>
